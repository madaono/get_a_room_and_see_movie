<template>
  <div class="itemBody clearfix" @click="pushChooseInfo(item.uid, item.path)">
    <div class="left">
      <img :src="item.thumb" alt="" class="searchImg">
      <div class="info">
    ...
    <div class="right">
      <div class="movieTitle">{{item.name}}</div>
      <div class="fileSize">{{Math.floor(item.size/1048567)}}MB</div>
    </div>
  </div>
</template>
